package com.jhipsterangularjs.test.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterAngularJs");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterAngularJs");
        ...
        config.getMapConfigs().put("com.jhipsterangularjs.test.domain.*", initializeDomainMapConfig(jHipsterProperties));
